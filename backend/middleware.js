// middleware.js — ejercicio aparte: dos porteros en fila.
// No es el login de Narnia. Si lo arrancás, también usa el puerto 3000 (no los dos a la vez).

const express = require("express");
const app = express();

// Primer portero: ¿trajiste invitación en la dirección?  /entrar?invitado=true
...
// Segundo portero: ¿las credenciales de la dirección dicen true?
...
// Solo si los dos dijeron que sí, llega el mensaje de bienvenida al evento.
